...
if __name__=='__main__':
  ...
  code_dir = os.path.dirname(os.path.realpath(__file__))
  parser.add_argument('--ycbv_dir', type=str, default="/home/shaol/hyw/dataset/YCB_video_BOP/ycbv", help="data dir") # /home/shaol/hyw/dataset/YCB-Video-Base, /mnt/9a72c439-d0a7-45e8-8d20-d7a235d02763/DATASET/YCB_Video
  parser.add_argument('--use_reconstructed_mesh', type=int, default=0)
  parser.add_argument('--ref_view_dir', type=str, default="/home/shaol/hyw/dataset/ycbv/ref_views_16") # /mnt/9a72c439-d0a7-45e8-8d20-d7a235d02763/DATASET/YCB_Video/bowen_addon/ref_views_16
